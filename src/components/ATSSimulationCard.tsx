...
export function ATSSimulationCard({ simulation }: ATSSimulationCardProps) {
  return (
    <div className="rounded-xl border bg-card p-6 shadow-sm space-y-5">
      <div>
        <h3 className="text-lg font-semibold">ATS Simulation</h3>
        <p className="text-sm text-muted-foreground mt-1">
          What an automated screening system sees vs what a recruiter expects
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium">Keywords Detected ({simulation.detectedKeywords.length})</p>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium">Keywords Missed ({simulation.missedKeywords.length})</p>
          </div>
